          ...
          <div className="bg-card border border-border rounded-2xl overflow-hidden shadow-sm">
            ...
            <div className="p-0">
              ...
              <div className="h-32 md:h-44 bg-gradient-to-r from-primary via-primary/90 to-accent relative overflow-hidden">
                ...
                <div
                  className="absolute bottom-4 right-6 text-primary-foreground/20 font-display text-4xl italic font-light pointer-events-none select-none"
                  aria-hidden="true"
                >
                  Marketing
                </div>
              ...
              <div className="px-6 md:px-10 pb-8">
                ...
                <div className="mb-6 pb-6 border-b border-border">
                  <h4 className="text-sm font-bold uppercase tracking-wide-xl text-foreground mb-3">
                    About
                  </h4>
                  <p className="text-sm text-muted-foreground leading-relaxed max-w-2xl">
                    I&apos;m a marketing student who believes the best campaigns are built on
                    genuine human insight — not just data dashboards. I&apos;ve spent the last two
                    years learning what moves people: through consumer behavior research, hands-on
                    social media management, and a summer internship where I got to test those ideas
                    in the real world.
                  </p>
                  <p className="text-sm text-muted-foreground leading-relaxed max-w-2xl mt-3">
                    I&apos;m drawn to brand strategy and integrated marketing because I love the
                    challenge of making something complex feel simple and something simple feel
                    compelling. Currently looking for marketing coordinator and brand associate
                ...
                {/* Experience snippet */}
                <div className="mb-6 pb-6 border-b border-border">
                  <h4 className="text-sm font-bold uppercase tracking-wide-xl text-foreground mb-4">
                    Experience
                  </h4>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Bloom Creative Agency · Jun 2025 – Aug 2025
                      </p>
                      <p className="text-xs text-muted-foreground mt-1">
                        Grew client Instagram engagement 34% · Managed 4 brand accounts · Weekly
                        analytics reporting
                      </p>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      <span
                        key={skill}
                        className="text-xs font-medium text-foreground bg-secondary border border-border px-3 py-1.5 rounded-full"
                      >
                        {skill}
                      </span>
                    ))}
