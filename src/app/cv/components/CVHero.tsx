    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 relative z-10">
        ...
        <nav className="flex items-center gap-2 mb-10" aria-label="Breadcrumb">
          <Link
            href="/"
            className="text-xs font-semibold uppercase tracking-super text-muted-foreground hover:text-accent transition-colors"
          >
            Home
          </Link>
        ...
        <div className="max-w-3xl">
          ...
          <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-xl opacity-initial">
            Three core documents for the Job Seeking package — each presented with the final
            version, a revision narrative documenting the evolution, and peer feedback received
