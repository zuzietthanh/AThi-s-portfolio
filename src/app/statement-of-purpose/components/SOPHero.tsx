...
export default function SOPHero() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-0 right-8 opacity-[0.04] pointer-events-none select-none"
        aria-hidden="true"
      >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 relative z-10">
        ...
        <nav className="flex items-center gap-2 mb-10" aria-label="Breadcrumb">
          <Link
            href="/"
            className="text-xs font-semibold uppercase tracking-super text-primary-foreground/40 hover:text-accent transition-colors"
          >
            Home
          </Link>
          <span className="text-primary-foreground/20 text-xs" aria-hidden="true">
            /
          </span>
        ...
        <div className="max-w-3xl">
          <span className="section-label opacity-initial block mb-6">Artifact 01 · Reflection</span>
          ...
          <p className="text-base md:text-lg text-primary-foreground/60 leading-relaxed max-w-xl opacity-initial">
            A personal reflection on my professional goals, the documents I have chosen to include
            in this portfolio, and how this body of work connects to my future in marketing.
          </p>
        </div>
      </div>
    </section>
